...
String.implement('box', function (string) {
    return instanceOf(string, Object) ? this : new String(this);
});

Boolean.implement('box', function (bool) {
    return instanceOf(bool, Object) ? this : new Boolean(this);
});

Number.implement('box', function (num) {
    return instanceOf(num, Object) ? this : new Number(this);
});
...
var Attribute = Class.Attribute = new Class({
    ...
    // TODO: API Classes, that can be implemented into a class, yet don't
    // pass doeschecks, yet have methods, that are detected by does.
